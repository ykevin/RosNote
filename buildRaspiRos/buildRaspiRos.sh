...
echo "获取相关包的源代码到工作目录"
rosinstall_generator desktop navigation move_base amcl map-server  nav-core --rosdistro indigo --deps --wet-only --exclude roslisp --tar > indigo-desktop-wet.rosinstall
